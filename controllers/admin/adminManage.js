...
const admin = {
    ...
    register(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const errorMsg = [];
            // 檢查信箱是否已使用
            const adminCheck = yield hostModel_1.default.findOne({ "email": email });
            if (adminCheck) {
            ...
            const newAdmin = yield hostModel_1.default.create({
                email,
                account,
                password,
                username,
    ...
    updateProfiles(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield hostModel_1.default.findByIdAndUpdate(req.admin.id, { $set: updateData });
    ...
    updatePassword(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const host = yield hostModel_1.default.findOne({ hostId }).select('+password');
            if (host) {
                const auth = yield bcryptjs_1.default.compare(password, host.password);
                if (!auth) {
                ...
                yield hostModel_1.default.findByIdAndUpdate(req.admin.id, { password: newPassword });
    ...
    deleteHost(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            yield hostModel_1.default.deleteOne({ id: req.params.id });
